...
#define DT_DRV_COMPAT issi_is66wvhxx
...
#define DEVICE_NODE DT_INST(0, DT_DRV_COMPAT)
...
#if DT_NODE_HAS_PROP(CONTROLLER_NODE, clocks)
...
#else
	data->freq = DT_PROP(CONTROLLER_NODE, clock_frequency);
#endif
