...
static struct mt9m114_reg mt9m114_648_488[] = {
	{MT9M114_CAM_SENSOR_CFG_Y_ADDR_START, 2, 0x0000},     /* 0 */
	{MT9M114_CAM_SENSOR_CFG_X_ADDR_START, 2, 0x0000},     /* 0 */
	{MT9M114_CAM_SENSOR_CFG_Y_ADDR_END, 2, 0x03CD},       /* 973 */
	{MT9M114_CAM_SENSOR_CFG_X_ADDR_END, 2, 0x050D},       /* 1293 */
	...
	{MT9M114_CAM_STAT_AE_INITIAL_WINDOW_XEND, 2, 0x007F}, /* 127 */
	{MT9M114_CAM_STAT_AE_INITIAL_WINDOW_YEND, 2, 0x005F}, /* 95 */
	{0xC810, 2, 0x35B},   /* CAM_SENSOR_CFG_FINE_INTEG_TIME_MAX = 859 */
	{0xC812, 2, 0x333},   /* CAM_SENSOR_CFG_FRAME_LENGTH_LINES = 819 */
	{0xC814, 2, 0x3DE},   /* CAM_SENSOR_CFG_LINE_LENGTH_PCK = 990 */
	{0xC818, 2, 0x1E3},   /* CAM_SENSOR_CFG_CPIPE_LAST_ROW = 483 */
	{0xC834, 2, 0x110},   /* CAM_SENSOR_CONTROL_READ_MODE = 272 */
	{0xC88C, 2, 0x1D9A},  /* CAM_AET_MAX_FRAME_RATE = 7578 (30 fps) */
	{0xC88E, 2, 0x1D9A},  /* CAM_AET_MIN_FRAME_RATE = 7578 (30 fps) */
	{/* NULL terminated */}};
...
#if (!IS_ENABLED(CONFIG_MT9M114_PARALLEL_INIT))
	{.width = 648, .height = 488, .params = mt9m114_648_488},
...
#else
	MT9M114_VIDEO_FORMAT_CAP(640, 480, VIDEO_PIX_FMT_GREY),
	MT9M114_VIDEO_FORMAT_CAP(648, 488, VIDEO_PIX_FMT_Y10P),
