...
DEFINE_MM_REG_READ(ss_scl_hcnt, DW_IC_REG_SS_SCL_HCNT, 32)
DEFINE_MM_REG_WRITE(ss_scl_hcnt, DW_IC_REG_SS_SCL_HCNT, 32)
DEFINE_MM_REG_READ(ss_scl_lcnt, DW_IC_REG_SS_SCL_LCNT, 32)
...
DEFINE_MM_REG_READ(fs_scl_lcnt, DW_IC_REG_FS_SCL_LCNT, 32)
DEFINE_MM_REG_WRITE(fs_scl_lcnt, DW_IC_REG_FS_SCL_LCNT, 32)

DEFINE_MM_REG_READ(hs_scl_hcnt, DW_IC_REG_HS_SCL_HCNT, 32)
DEFINE_MM_REG_WRITE(hs_scl_hcnt, DW_IC_REG_HS_SCL_HCNT, 32)
DEFINE_MM_REG_READ(hs_scl_lcnt, DW_IC_REG_HS_SCL_LCNT, 32)
...
DEFINE_MM_REG_READ(intr_mask, DW_IC_REG_INTR_MASK, 32)
...
DEFINE_MM_REG_READ(rx_tl, DW_IC_REG_RX_TL, 32)
DEFINE_MM_REG_WRITE(rx_tl, DW_IC_REG_RX_TL, 32)
DEFINE_MM_REG_READ(tx_tl, DW_IC_REG_TX_TL, 32)
...
DEFINE_MM_REG_READ(sar, DW_IC_REG_SAR, 32)
