 ...
 *
 * Private descriptor and protocol definitions for the USB Video Class. Taken
 * verbatim from the upstream Zephyr v4.2 implementation; the accompanying
 * usbd_uvc.c is adapted to a Zephyr revision whose video subsystem still uses
 * the endpoint-based (enum video_endpoint_id) API.
 */
