...
class AlifImageBinaryRunner(ZephyrBinaryRunner):
    ...
    def debug(self, attach=False, **kwargs):
        ...
        Parameters:
            attach (bool): If True, connects to a running process without resetting the target.
            **kwargs: Additional keyword arguments passed to subprocess calls.
        Behavior:
            - Checks for required tools.
            - Prepares server and client commands for J-Link GDB server and GDB client.
            - Requires an ELF file for debugging.
            - If attach is False, resets the target before debugging.
            - Launches server and client subprocesses to start the debug session.
        '''
