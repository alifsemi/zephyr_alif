...
class AlifImageBinaryRunner(ZephyrBinaryRunner):
    ...
    def __init__(self, cfg, device,
        ...
        DEFAULT_JLINK_EXE, DEFAULT_JLINK_GDB_PORT, DEFAULT_JLINK_GDB_SERVER = self._get_jlink_defaults()
    ...
    def do_add_parser(cls, parser):
        # Load J-Link defaults (raises if unavailable)
        DEFAULT_JLINK_EXE, DEFAULT_JLINK_GDB_PORT, DEFAULT_JLINK_GDB_SERVER = cls._get_jlink_defaults()
